...
def main():
    ...
    parser.add_argument('--device', type=str, choices=['cpu', 'cuda'],
                        ...
                        help='选择cpu 或 cuda. 默认: 如果cuda可用选择cuda,否则cpu')
    ...
    if args.do_train:
        ...
        for epoch in range(args.epochs):
            ...
            print(
                f"Train Loss: {train_loss:.4f} | Val Loss: {val_loss:.4f} | Val Acc: {val_acc:.4f} | Top-5: {val_top5:.4f} | F1: {val_f1:.4f}")
    ...
    if args.do_test:
        ...
        torch.cuda.reset_peak_memory_stats(device=args.device) if args.device.type == "cuda" else None
