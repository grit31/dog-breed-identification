...
def main():
    ...
    parser.add_argument('--sample_submission', type=str, default='VGGsample_submission.csv')
    ...
    parser.add_argument('--model_path', type=str, default='vgg11_V1.pth')
