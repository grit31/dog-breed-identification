...
def main():
    ...
    parser.add_argument('--train_dir', type=str, default='../dog-breed-identification/train')
    parser.add_argument('--test_dir', type=str, default='../dog-breed-identification/test')
    parser.add_argument('--labels', type=str, default='../dog-breed-identification/labels.csv')
    parser.add_argument('--sample_submission', type=str, default='../dog-breed-identification/sample_submission.csv')
    ...
    parser.add_argument('--model_path', type=str, default='vgg11best.pth')
    ...
    if args.do_train:
        ...
        pd.DataFrame({
            ...
            'top5': top5_history,
            'f1': f1_history
        }).to_csv('train_metric.csv', index=False)
        plot_metric(loss_history, 'Loss', 'loss_curve.png')
        plot_metric(acc_history, 'Accuracy', 'acc_curve.png')
        plot_metric(top3_history, 'Top3_Accuracy', 'top3_curve.png')
        plot_metric(top5_history, 'Top5_Accuracy', 'top5_curve.png')
        plot_metric(f1_history, 'F1', 'f1_curve.png')
