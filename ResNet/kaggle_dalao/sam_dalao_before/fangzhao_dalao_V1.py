...
#
# # =============== 2. 路径前缀配置 ===============
# data_dir = r'D:\homework\Course_Design_of_artificial_intelligence\third\dog-breed-identification'    # 你的数据目录
# save_dir =r'D:\homework\Course_Design_of_artificial_intelligence\third\ResNet\kaggle_dalao\sam_dalao_before'                                   # 结果/模型保存目录
#
# # =============== 3. 标签处理 ===============
# le = LabelEncoder()
